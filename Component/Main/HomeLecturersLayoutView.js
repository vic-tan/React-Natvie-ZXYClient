    ...
    render() {
        return (
            <HomeBaseOptionalLayoutView sid={this.props.sid}
                                        ...
                                        url={UrlConstant.SYS_FIND_INDEX_RECOMMEND_HOT_LECTURERS_LIST}
            />
        );
    }
        ...
        return (
            <TouchableOpacity key={rowID} activeOpacity={0.8}>
                <View style={styles.itemViewStyle}>
                    <Image source={{uri: rowData.head_photo}} style={styles.imageStyle}/>
                    <Text style={styles.shopNameStyle}>{rowData.name}</Text>
                </View>
            </TouchableOpacity>
        );
    }
