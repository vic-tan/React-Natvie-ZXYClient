...
class ExamDoadingView extends Component {
    constructor(props) {
        super(props);
        this.state={
            tab:0,
            ...
            <View >
                <View style={styles.rowContainer}>
                    ...
                    <View style={{margin: 10 ,width:width -130}} >
                        ...
                        <Text style={styles.rowDesc} numberOfLines={1}>发布人: {rowData.test_time}</Text>
                    </View>
                </View>
                <Text style={{height:1}}/>
            </View>
...
export default ExamDoadingView;
